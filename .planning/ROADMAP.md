...
**Plans:** 7 plans (4 executed, 3 gap closure from verification CR-01..CR-04)
...
- [ ] 02-06-PLAN.md — CR-01 gap: purchased_credits schema separation, free-first consumption, reset preservation (wave 1, cross-repo TDD)
